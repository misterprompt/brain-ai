...
export class CoachService {
    private static readonly API_URL = 'https://api.deepseek.com/v1/chat/completions'; // Hypothetical URL
    private static readonly MODEL = 'deepseek-reasoner'; // R1 model

    static async getCoachAdvice(gameId: string, userId: string, language: string = 'en'): Promise<CoachResponse> {
    ...
    `;
        ...
        try {
            ...
            throw new AppError('Failed to get coach advice', 500);
        }
    }
}
