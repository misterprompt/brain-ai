...
export type NotificationKind = 'quota_exhausted' | 'quota_reset' | 'victory' | 'invitation' | 'tournament_update';
...
export type NotificationEnvelope = QuotaExhaustedNotification | QuotaResetNotification | VictoryNotification | InvitationNotification | TournamentUpdateNotification;
